...
function CivilAI::MakeGroups() {
    ...
    if (AIGroup.SetName(Groups[0], "Buses")) {} else {
        AIGroup.SetName(Groups[0], "Buses " + Me)
    }
    if (AIGroup.SetName(Groups[1], "Cars")) {} else {
        AIGroup.SetName(Groups[1], "Cars " + Me)
    }
    if (AIGroup.SetName(Groups[2], "Mail")) {} else {
        AIGroup.SetName(Groups[2], "Mail " + Me)
    }
    if (AIGroup.SetName(Groups[3], "Goods")) {} else {
        AIGroup.SetName(Groups[3], "Goods " + Me)
    }

    if (AIGroup.SetName(Groups[4], "Passenger")) {} else {
        AIGroup.SetName(Groups[4], "Passenger " + Me)
    }
    if (AIGroup.SetName(Groups[5], "Freighter")) {} else {
        AIGroup.SetName(Groups[5], "Freighter " + Me)
    }

    if (AIGroup.SetName(Groups[6], "Commuter")) {} else {
        AIGroup.SetName(Groups[6], "Commuter " + Me)
    }
    if (AIGroup.SetName(Groups[7], "Freight")) {} else {
        AIGroup.SetName(Groups[7], "Freight " + Me)
    }
}
...
function CivilAI::LoadGroups() {
    ...
    foreach(group, z in glist) {
        ...
        if (AIGroup.GetName(group) == "Buses" || AIGroup.GetName(group) == "Buses " + Me) {
            Groups[0] = group;
        } else if (AIGroup.GetName(group) == "Cars" || AIGroup.GetName(group) == "Cars " + Me) {
            Groups[1] = group;
        } else if (AIGroup.GetName(group) == "Mail" || AIGroup.GetName(group) == "Mail " + Me) {
            Groups[2] = group;
        } else if (AIGroup.GetName(group) == "Goods" || AIGroup.GetName(group) == "Goods " + Me) {
            Groups[3] = group;
        } else if (AIGroup.GetName(group) == "Passenger" || AIGroup.GetName(group) == "Passenger " + Me) {
            Groups[4] = group;
        } else if (AIGroup.GetName(group) == "Freighter" || AIGroup.GetName(group) == "Freighter " + Me) {
            Groups[5] = group;
        } else if (AIGroup.GetName(group) == "Commuter" || AIGroup.GetName(group) == "Commuter " + Me) {
            Groups[6] = group;
        } else if (AIGroup.GetName(group) == "Freight" || AIGroup.GetName(group) == "Freight " + Me) {
            Groups[7] = group;
        }
    }
