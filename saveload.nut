...
function CivilAI::Load(version, data) {
    ...
    if ("sBiasCheap" in data) {
        BiasCheap = data.sBiasCheap;
    } else {
        BiasCheap = 10;
    }
    if ("sBiasFast" in data) {
        BiasFast = data.sBiasFast;
    } else {
        BiasFast = 10;
    }
    if ("sBiasBig" in data) {
        BiasBig = data.sBiasBig;
    } else {
        BiasBig = 10;
    }
    if ("sRoadType" in data) {
        AIRoad.SetCurrentRoadType(data.sRoadType);
    } else {
        SelectRoadType(true);
    }
